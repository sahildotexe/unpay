    ...
    <div className="main-app">
              ...
              {smartAccount && smartAccount.address && (
                <Box p="2">
                  <Heading size="sm">
                    signed in as:
                    <Link
                      href={`https://explorer-mumbai.maticvigil.com/address/${smartAccount.address}`}
                      isExternal
                    >
                      {" " +
          ...
          <Box m="5">
            ...
            <Center>
              <Text
                ...
                p={{ base: "2", md: "6" }}
              >
                introducing the easiest way to buy your first crypto. Unpay
                allows you to buy crypto with your spare change.
              </Text>
            </Center>
          </Box>
      ...
      {loading && (
        <Box minHeight="max-content" className="loading">
          <Center>
            <Spinner m="2" size="xl" color="blue" />
          </Center>
        </Box>
      )}
      {!!smartAccount && (
